...
subtitle: "Модель хищник-жертва - вариант 40"
...
$$
 \begin{cases}
	\frac{dx}{dt} = (-0.83x(t) + 0.043y(t)x(t))
	\\   
	\frac{dy}{dt} = (0.84y(t) - 0.024y(t)x(t))
 \end{cases}
$$

Постройте график зависимости численности хищников от численности жертв, а также графики изменения численности хищников и численности жертв 
при следующих начальных условиях: $x_0=10, y_0=20$
...
Стационарное состояние $x_0=19.302, y_0=35$
